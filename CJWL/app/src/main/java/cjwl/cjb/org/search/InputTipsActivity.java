...
import cjwl.cjb.org.search.adapter.InputTipsAdapter;
import cjwl.cjb.org.search.util.Constants;
import cjwl.cjb.org.search.util.ToastUtil;
...
public class InputTipsActivity extends Activity implements SearchView.OnQueryTextListener, Inputtips.InputtipsListener, OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (mCurrentTipList != null) {
            ...
            setResult(SearchActivity.RESULT_CODE_INPUTTIPS, intent);
            this.finish();
        }
    }
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        setResult(SearchActivity.RESULT_CODE_KEYWORDS, intent);
        this.finish();
        return false;
    }
